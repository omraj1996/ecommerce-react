...
export default function Product() {
  ...
  const hadlePaginationChange=(event,value)=>{
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
          ...
          <section className="w-full px=[3.6rem">
            <div className="px-4 py-5 flex justify-cebter">
            <Pagination count={products.products?.totalPages} color="secondary" onChange={hadlePaginationChange} />
            </div>
          </section>
        </main>
      </div>
